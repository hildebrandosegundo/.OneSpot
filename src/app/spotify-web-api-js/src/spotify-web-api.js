...
var SpotifyWebApi = (function() {
   ...
   * @return {Object} Null if a callback is provided, a `Promise` object otherwise
   */
  Constr.prototype.getMyTopTracks = function(url, options, callback) {
    var requestData = {
  ...
  Constr.prototype.next = function(url,options, callback) {
    var requestData = {
      url: url
    };
    return _checkParamsAndPerformRequest(requestData, options, callback);
  };
  Constr.prototype.prev = function(options, callback) {
    var requestData = {
      url: url
    };
    return _checkParamsAndPerformRequest(requestData, options, callback);
