...
declare namespace SpotifyWebApiJs {
    ...
    interface SpotifyWebApiJs {
       ...
       * @return {Object} Null if a callback is provided, a `Promise` object otherwise
       */
      next(query: string, options?: SpotifyApi.SearchForItemParameterObject, callback?: ResultsCallback<SpotifyApi.AlbumSearchResponse>) : Promise<SpotifyApi.AlbumSearchResponse>;
      prev(query: string, options?: SpotifyApi.SearchForItemParameterObject, callback?: ResultsCallback<SpotifyApi.AlbumSearchResponse>) : Promise<SpotifyApi.AlbumSearchResponse>;
